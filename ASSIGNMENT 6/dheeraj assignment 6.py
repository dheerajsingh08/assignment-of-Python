...
student_data(student_id="21102008")
student_data(student_id="21102008",student_name="Dheeraj Singh")
student_data(student_id="21102008",student_name="Dheeraj Singh",student_class="1st Year")
print()
